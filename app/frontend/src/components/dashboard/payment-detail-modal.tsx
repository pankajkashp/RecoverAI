              ...
              <div className="p-4 space-y-3 bg-muted/10">
                ...
                >
                  ...
                  {payment.recommendation.action !== "RETRY_PAYMENT" ? (
                    ...
                    /* Already attempted prior to opening modal */
                    <div className="rounded-lg border border-sky-500/30 bg-sky-500/10 p-3 flex items-center justify-between gap-2">
                      <div className="flex items-center gap-2 text-xs font-semibold text-sky-800 dark:text-sky-300">
                        ...
                        <span>Recovery Attempt Executed</span>
                        <span className="text-[11px] font-normal text-muted-foreground">
                          — Razorpay Payment Link active (awaiting provider confirmation)
                        </span>
                      </div>
                    </div>
                  ) : executionResult ? (
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-1">
                        <p className="text-[11px] text-muted-foreground">
                          Creates a Razorpay Payment Link for customer recovery retry.
                        </p>
                        <button
                          type="button"
